...
public class BeliAdapter extends ArrayAdapter<trans> {
    Context mctk;
    int listLayoutRes;
    ...
    public BeliAdapter(Context mctk, int listLayoutRes, List<trans> transList, SQLiteDatabase db, String kdtrans) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        hps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                db.execSQL("DELETE FROM DETAILBELI1 WHERE KDBELI ='" + isi.getKdtrans() + "'AND KDBARANG ='"+isi.getKdbar()+"';");
                reloadDataBeli();
            }
        });
