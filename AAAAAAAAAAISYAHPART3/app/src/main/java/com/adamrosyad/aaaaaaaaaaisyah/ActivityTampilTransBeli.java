...
public class ActivityTampilTransBeli extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_trans_beli);
...
//        total.setText(tot.getInt(tot.getColumnIndex("TOTAL")));
        ...
        btnsimpan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                db.execSQL("INSERT INTO TRANSBELI  VALUES('"+ kdtrans.getText().toString() +"','"
                        + dateView.getText() + "','"
                        ...
                        + kembali.getText() +"');");
                finish();
                Toast.makeText(ActivityTampilTransBeli.this, "Transaksi Berhasil Disimpan", Toast.LENGTH_LONG).show();
            }
        });
        btnbatal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                db.execSQL("DELETE FROM DETAILBELI1 WHERE KDBELI ='" + kdtrans.getText().toString() + "';");
                db.execSQL("DELETE FROM TRANSBELI WHERE KDBELI ='" + kdtrans.getText().toString() + "';");
                finish();
                Toast.makeText(ActivityTampilTransBeli.this, "Transaksi Dibatalkan!", Toast.LENGTH_LONG).show();
            }
        });
