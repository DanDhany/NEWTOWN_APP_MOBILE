...
public class JualAdapter extends ArrayAdapter<trans> {
    Context mctk;
    int listLayoutRes;
    ...
    public JualAdapter(Context mctk, int listLayoutRes, List<trans> transList, SQLiteDatabase db, String kdtrans) {
